 ...
 * quantity ordered.
 * Each OrderItem links to a Product to access current pricing and details.
 * 
...
public class OrderItem {
    ...
    private Product product; /**  The product being ordered. Direct reference to Product to access current
                            price/info */
